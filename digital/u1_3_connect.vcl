...
! ITL Test Source File:      digital/u1_3_connect
! Test Name:                 U1_3
! VCL created for chain:     U29_U1_3
! Date: Wed May 11 16:54:29 2022
...
assign N0000 to nodes "CLK_OBS_EN_3" ! Pin(s) AM4
assign N0006 to nodes "FPGA_SNDN_GPIO10" ! Pin(s) L10
assign N0007 to nodes "FPGA_SNDN_GPIO11" ! Pin(s) AK2
assign N0008 to nodes "FPGA_SNDN_GPIO12" ! Pin(s) AK4
assign N0009 to nodes "FPGA_SNDN_GPIO13" ! Pin(s) AK8
assign N0010 to nodes "FPGA_SNDN_GPIO14" ! Pin(s) AK7
assign N0011 to nodes "FPGA_SNDN_GPIO15" ! Pin(s) AK5
assign N0012 to nodes "FPGA_SNDN_GPIO16" ! Pin(s) AL1
assign N0013 to nodes "FPGA_SNDN_GPIO17" ! Pin(s) AL2
assign N0014 to nodes "FPGA_SNDN_GPIO18" ! Pin(s) AL3
assign N0015 to nodes "FPGA_SNDN_GPIO19" ! Pin(s) AL9
assign N0016 to nodes "FPGA_SNDN_GPIO20" ! Pin(s) AL10
assign N0017 to nodes "FPGA_SNDN_GPIO21" ! Pin(s) AL11
assign N0001 to nodes "FPGA_SNDN_GPIO5" ! Pin(s) L5
assign N0002 to nodes "FPGA_SNDN_GPIO6" ! Pin(s) K12
assign N0003 to nodes "FPGA_SNDN_GPIO7" ! Pin(s) K11
assign N0004 to nodes "FPGA_SNDN_GPIO8" ! Pin(s) L8
assign N0005 to nodes "FPGA_SNDN_GPIO9" ! Pin(s) L7
assign N0018 to nodes "FPGA_SNDN_HW_I2C_SCL" ! Pin(s) AM10
assign N0019 to nodes "FPGA_SNDN_HW_I2C_SDA" ! Pin(s) AM6
...
assign N0020 to nodes "PLL_OBS_EN_3" ! Pin(s) AM5
assign N0021 to nodes "SNDN_CORE_FREQ_SEL_0" ! Pin(s) AL4
assign N0022 to nodes "SNDN_CORE_FREQ_SEL_1" ! Pin(s) AM8
assign N0023 to nodes "SNDN_CORE_PLL_BYP" ! Pin(s) N8
assign N0024 to nodes "SNDN_CORE_PLL_RST_L" ! Pin(s) N3
assign N0025 to nodes "SNDN_CORE_RESET_L" ! Pin(s) N4
assign N0026 to nodes "SNDN_PCIE_CORE_RST_L" ! Pin(s) M11
assign N0027 to nodes "SNDN_PCIE_PE_RST_L" ! Pin(s) N6
assign N0028 to nodes "SNDN_PCIE_PLL_BYP" ! Pin(s) N7
assign N0029 to nodes "SNDN_PCIE_PLL_RST_L" ! Pin(s) M7
assign N0030 to nodes "SNDN_PTP_SYNC_MASTER" ! Pin(s) AL8
assign N0031 to nodes "SNDN_PTP_SYNC_SLAVE" ! Pin(s) AL6
assign N0032 to nodes "SNDN_USR_DRV_EN" ! Pin(s) M8
...
inputs          N0000, N0020, N0024, N0025, N0026, N0027, N0029
bidirectional   N0006, N0007, N0008, N0009, N0010, N0011, N0012, N0013
bidirectional   N0014, N0015, N0016, N0017, N0001, N0002, N0003, N0004
bidirectional   N0005, N0018, N0019, N0021, N0022, N0023, N0028, N0030
bidirectional   N0031, N0032
 
inputs          D0000, D0001, D0006, D0002, D0003, D0004, D0005
 
use cards hybrid         on N0000, N0006, N0007, N0008, N0009, N0010, N0011, N0012
use cards hybrid         on N0013, N0014, N0015, N0016, N0017, N0001, N0002, N0003
use cards hybrid         on N0004, N0005, N0018, N0019, N0020, N0021, N0022, N0023
...
!SJJJJCFFFFFFFFFFFFFFFFFFFPSSSSSSSSSSSS!
!RTTTTLPPPPPPPPPPPPPPPPPPPLNNNNNNNNNNNN!
!TAAAAKGGGGGGGGGGGGGGGGGGGLDDDDDDDDDDDD!
!_GGGG_AAAAAAAAAAAAAAAAAAA_NNNNNNNNNNNN!
!J____O___________________O____________!
!TTTTTBSSSSSSSSSSSSSSSSSSSBCCCCCPPPPPPU!
!AMDDRSNNNNNNNNNNNNNNNNNNNSOOOOOCCCCTTS!
!GSIOS_DDDDDDDDDDDDDDDDDDD_RRRRRIIIIPPR!
!____TENNNNNNNNNNNNNNNNNNNEEEEEEEEEE___!
!THHH_N___________________N_________SSD!
!CDDDL_GGGGGGGGGGGGGGGGGHH_FFPPRCPPPYYR!
!KRRR_3PPPPPPPPPPPPPPPPPWW3RRLLEOELLNNV!
!____H IIIIIIIIIIIIIIIII__ EELLSR_LLCC_!
!H3C3D OOOOOOOOOOOOOOOOOII QQ__EER____E!
!DVPVR 5678911111111112222 __BRT_SBRMSN!
!R3L3_      012345678901CC SSYS_RTYSAL !
!_ D 3                  __ EEPTLS_PTSA !
!3 1 V                  SS LL _ TL _TV !
!V _ 3                  CD __ L _  LEE !
!3 3                    LA 01   L   R  !
!  V                                   !
!  3                                   !
...
"01ZX0ZXXXXXXXXXXXXXXXXXXXZXXXZZZZXZXXX"
...
"10ZX1"!Run-Test/Idle
use pcf order Parallel
"01ZX1ZXXXXXXXXXXXXXXXXXXXZXXXZZZZXZXXX"
use pcf order Scan
...
use pcf order Parallel
"00ZX1ZXXXXXXXXXXXXXXXXXXXZXXXZZZZXZXXX"
"10ZX1ZXXXXXXXXXXXXXXXXXXXZXXXZZZZXZXXX"!Run-Test/Idle
"01ZX1ZXXXXXXXXXXXXXXXXXXXZXXXZZZZXZXXX"
use pcf order Scan
"11ZX1"!Select-DR-Scan
use pcf order Parallel
...
use pcf order Parallel
"00ZX1ZXXXXXXXXXXXXXXXXXXXZXXXZZZZXZXXX"
"10ZX1ZXXXXXXXXXXXXXXXXXXXZXXXZZZZXZXXX"!Shift-DR
end pcf
message "IEEE Std 1149.1-2001 Integrity Failure"
message "  Device U1_3 has failed,"
message "  suspect device or these pins:"
...
pcf
use pcf order Parallel
"001H1ZXXXXXXXXXXXXXXXXXXXZXXXZZZZXZXXX"!0+0
use pcf order Scan
"101X1"
end pcf
...
use pcf order Parallel
"00ZX1ZXXXXXXXXXXXXXXXXXXXZXXXZZZZXZXXX"
"10ZX1ZXXXXXXXXXXXXXXXXXXXZXXXZZZZXZXXX"!Run-Test/Idle Vector 1300
"01ZX1ZXXXXXXXXXXXXXXXXXXXZXXXZZZZXZXXX"
use pcf order Scan
"11ZX1"!Select-DR-Scan
...
pcf
use pcf order Parallel
"00ZX1ZXXXXXXXXXXXXXXXXXXXZXXXZZZZXZXXX"!0+0
use pcf order Scan
"10ZX1"
"000X1"!1
"100X1"
...
use pcf order Parallel
"00ZX1ZXXXXXXXXXXXXXXXXXXXZXXXZZZZXZXXX"
"10ZX1ZXXXXXXXXXXXXXXXXXXXZXXXZZZZXZXXX"!Run-Test/Idle Vector 4725
"01ZX1ZXXXXXXXXXXXXXXXXXXXZXXXZZZZXZXXX"
use pcf order Scan
"11ZX1"!Select-DR-Scan
"01ZX1"
...
"10ZX1ZZZZZZZZZZZZZ00000000000000000000"! Vector 4925
...
"10ZX1ZZZZZZZZZZZZZZZZZZZZ0000000000000"
...
pcf
use pcf order Parallel
"000L1ZXXXXXXXXXXXXXXXXXXXZXXXZZZZXZXXX"!0+0
use pcf order Scan
"100X1"
"001X1"!1
"101X1"
...
use pcf order Parallel
"00ZX1ZXXXXXXXXXXXXXXXXXXXZXXXZZZZXZXXX"! Vector 8375
use pcf order Scan
"10ZX1"!Capture-DR
use pcf order Parallel
...
"10ZX1ZZZ111111111111111111111111111111"
...
"10ZX1ZZZZZZZZZZZZZZZZZZZZZZ11111111111"! Vector 8400
...
"10ZX1ZZZZZZZZZZZZZZZZZZZZZZZZZZZZ11111"
...
pcf
use pcf order Parallel
"000H1ZXXXXXXXXXXXXXXXXXXXZXXXZZZZXZXXX"!0+0
use pcf order Scan
"100X1"
"001X1"!1
"101X1"
