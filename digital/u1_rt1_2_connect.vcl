...
! ITL Test Source File:      digital/u1_rt1_2_connect
! Test Name:                 U1_RT1_2
! VCL created for chain:     U29_U1_3
! Date: Wed May 11 15:23:17 2022
...
scan connect ! Test device U1_RT1_2
 
vector cycle  10000n
receive delay 8000n
 
assign N0000 to nodes "CONFIG_IO0_PULLUP_RT1_2" ! Pin(s) B7
assign N0001 to nodes "EEPROM_LOAD0_EN_RT1_2" ! Pin(s) D10
...
assign N0002 to nodes "RT1_ADDR<1>" ! Pin(s) R7
assign N0003 to nodes "RT1_ADDR<2>" ! Pin(s) P7
assign N0004 to nodes "RT1_ADDR<3>" ! Pin(s) P8
assign N0005 to nodes "RT1_ADDR<4>" ! Pin(s) N9
assign N0006 to nodes "RT1_M4_0_3_SYNCE_CLK" ! Pin(s) N10
assign N0007 to nodes "RT1_M4_4_7_SYNCE_CLK" ! Pin(s) P10
assign N0008 to nodes "RT1_MDIO_SCL" ! Pin(s) C9
assign N0009 to nodes "RT1_MDIO_SDA" ! Pin(s) C10
...
message ""
! Set up Chain for Connect Test of device U1_RT1_2
pcf
use pcf order Scan
"10ZX1"!Suppress Ground Bounce
use pcf order Parallel
...
"001X1"!8+0
"101X1"
! Loading device U1_RT1_2 register BOUNDARY[92] (for EXTEST).
end pcf
message "IEEE Std 1149.1-2001 Integrity Failure"
message "  Device U1_RT1_2 has failed,"
message "  suspect device or these pins:"
...
"001L1"!4
"101X1"
! Loading device U1_RT1_2 with instruction EXTEST(00000).
"000H1"!47+0
"100X1"! Vector 1625
"000L1"!1
"100X1"
...
"001L1"!8+0
"101X1"
! Unloading device U1_RT1_2 register BOUNDARY[92] (for EXTEST).
"001X1"!9+0
"101X1"
"001X1"!1
"101X1"
...
use pcf order Scan
"11ZX1"!Select-DR-Scan
! End of Connect Test for device U1_RT1_2
"01ZX1"
"11ZX1"!Select-IR-Scan
use pcf order Parallel
"01ZX1XXXXXXXXXX"
...
!   48  39 U1_RT1_2.R7   RT1_ADDR<1>     'LHXX'
!   50  41 U1_RT1_2.P7   RT1_ADDR<2>     'LHXX'
!   52  43 U1_RT1_2.P8   RT1_ADDR<3>     'LHXX'
!   54  45 U1_RT1_2.N9   RT1_ADDR<4>     'LHXX'
!   56  47 U1_RT1_2.P10  RT1_M4_4_7_SYNCE_CLK'LHXX'
!   58  49 U1_RT1_2.N10  RT1_M4_0_3_SYNCE_CLK'LHXX'
!   94  85 U1_RT1_2.C10  RT1_MDIO_SDA    'LHXX'
!   96  87 U1_RT1_2.C9   RT1_MDIO_SCL    'LHXX'
!   98  89 U1_RT1_2.D10  EEPROM_LOAD0_EN_RT1_2'LHXX'
!  100  91 U1_RT1_2.B7   CONFIG_IO0_PULLUP_RT1_2'LHXX'
