...
! ITL Test Source File:      digital/u1_rt3_4_connect
! Test Name:                 U1_RT3_4
! VCL created for chain:     U29_U1_3
! Date: Wed May 11 15:26:11 2022
...
scan connect ! Test device U1_RT3_4
 
vector cycle  10000n
receive delay 8000n
 
assign N0000 to nodes "CONFIG_IO0_PULLUP_RT3_4" ! Pin(s) B7
assign N0001 to nodes "EEPROM_LOAD0_EN_RT3_4" ! Pin(s) D10
...
assign N0002 to nodes "RT3_ADDR<1>" ! Pin(s) R7
assign N0003 to nodes "RT3_ADDR<2>" ! Pin(s) P7
assign N0004 to nodes "RT3_ADDR<3>" ! Pin(s) P8
assign N0005 to nodes "RT3_ADDR<4>" ! Pin(s) N9
assign N0006 to nodes "RT3_M4_0_3_SYNCE_CLK" ! Pin(s) N10
assign N0007 to nodes "RT3_M4_4_7_SYNCE_CLK" ! Pin(s) P10
assign N0008 to nodes "RT3_MDIO_SCL" ! Pin(s) C9
assign N0009 to nodes "RT3_MDIO_SDA" ! Pin(s) C10
...
message ""
! Set up Chain for Connect Test of device U1_RT3_4
pcf
use pcf order Scan
"10ZX1"!Suppress Ground Bounce
use pcf order Parallel
...
"001X1"!6+0
"101X1"
! Loading device U1_RT3_4 register BOUNDARY[92] (for EXTEST).
end pcf
message "IEEE Std 1149.1-2001 Integrity Failure"
message "  Device U1_RT3_4 has failed,"
message "  suspect device or these pins:"
...
"001L1"!4
"101X1"
! Loading device U1_RT3_4 with instruction EXTEST(00000).
"000H1"!37+0
"100X1"
"000L1"!1
"100X1"
...
"001L1"!6+0
"101X1"
! Unloading device U1_RT3_4 register BOUNDARY[92] (for EXTEST).
"001X1"!7+0
"101X1"
"001X1"!1
"101X1"
...
use pcf order Scan
"11ZX1"!Select-DR-Scan
! End of Connect Test for device U1_RT3_4
"01ZX1"
"11ZX1"!Select-IR-Scan
use pcf order Parallel
"01ZX1XXXXXXXXXX"
...
!   46  39 U1_RT3_4.R7   RT3_ADDR<1>     'LHXX'
!   48  41 U1_RT3_4.P7   RT3_ADDR<2>     'LHXX'
!   50  43 U1_RT3_4.P8   RT3_ADDR<3>     'LHXX'
!   52  45 U1_RT3_4.N9   RT3_ADDR<4>     'LHXX'
!   54  47 U1_RT3_4.P10  RT3_M4_4_7_SYNCE_CLK'LHXX'
!   56  49 U1_RT3_4.N10  RT3_M4_0_3_SYNCE_CLK'LHXX'
!   92  85 U1_RT3_4.C10  RT3_MDIO_SDA    'LHXX'
!   94  87 U1_RT3_4.C9   RT3_MDIO_SCL    'LHXX'
!   96  89 U1_RT3_4.D10  EEPROM_LOAD0_EN_RT3_4'LHXX'
!   98  91 U1_RT3_4.B7   CONFIG_IO0_PULLUP_RT3_4'LHXX'
