...
! ITL Test Source File:      digital/u1_rt5_6_connect
! Test Name:                 U1_RT5_6
! VCL created for chain:     U29_U1_3
! Date: Wed May 11 15:28:15 2022
...
scan connect ! Test device U1_RT5_6
 
vector cycle  10000n
receive delay 8000n
 
assign N0000 to nodes "CONFIG_IO0_PULLUP_RT5_6" ! Pin(s) B7
assign N0001 to nodes "EEPROM_LOAD0_EN_RT5_6" ! Pin(s) D10
...
assign N0002 to nodes "RT5_ADDR<1>" ! Pin(s) R7
assign N0003 to nodes "RT5_ADDR<2>" ! Pin(s) P7
assign N0004 to nodes "RT5_ADDR<3>" ! Pin(s) P8
assign N0005 to nodes "RT5_ADDR<4>" ! Pin(s) N9
assign N0006 to nodes "RT5_M4_0_3_SYNCE_CLK" ! Pin(s) N10
assign N0007 to nodes "RT5_M4_4_7_SYNCE_CLK" ! Pin(s) P10
assign N0008 to nodes "RT5_MDIO_SCL" ! Pin(s) C9
assign N0009 to nodes "RT5_MDIO_SDA" ! Pin(s) C10
...
message ""
! Set up Chain for Connect Test of device U1_RT5_6
pcf
use pcf order Scan
"10ZX1"!Suppress Ground Bounce
use pcf order Parallel
...
"001X1"!4+0
"101X1"
! Loading device U1_RT5_6 register BOUNDARY[92] (for EXTEST).
end pcf
message "IEEE Std 1149.1-2001 Integrity Failure"
message "  Device U1_RT5_6 has failed,"
message "  suspect device or these pins:"
...
"001L1"!4
"101X1"
! Loading device U1_RT5_6 with instruction EXTEST(00000).
"000H1"!27+0
"100X1"
"000L1"!1
"100X1"
...
"001L1"!4+0
"101X1"
! Unloading device U1_RT5_6 register BOUNDARY[92] (for EXTEST).
"001X1"!5+0
"101X1"
"001X1"!1
"101X1"
...
use pcf order Scan
"11ZX1"!Select-DR-Scan
! End of Connect Test for device U1_RT5_6
"01ZX1"
"11ZX1"!Select-IR-Scan
use pcf order Parallel
"01ZX1XXXXXXXXXX"
...
!   44  39 U1_RT5_6.R7   RT5_ADDR<1>     'LHXX'
!   46  41 U1_RT5_6.P7   RT5_ADDR<2>     'LHXX'
!   48  43 U1_RT5_6.P8   RT5_ADDR<3>     'LHXX'
!   50  45 U1_RT5_6.N9   RT5_ADDR<4>     'LHXX'
!   52  47 U1_RT5_6.P10  RT5_M4_4_7_SYNCE_CLK'LHXX'
!   54  49 U1_RT5_6.N10  RT5_M4_0_3_SYNCE_CLK'LHXX'
!   90  85 U1_RT5_6.C10  RT5_MDIO_SDA    'LHXX'
!   92  87 U1_RT5_6.C9   RT5_MDIO_SCL    'LHXX'
!   94  89 U1_RT5_6.D10  EEPROM_LOAD0_EN_RT5_6'LHXX'
!   96  91 U1_RT5_6.B7   CONFIG_IO0_PULLUP_RT5_6'LHXX'
