...
! ITL Test Source File:      digital/u1_rt7_8_connect
! Test Name:                 U1_RT7_8
! VCL created for chain:     U29_U1_3
! Date: Wed May 11 15:30:59 2022
...
scan connect ! Test device U1_RT7_8
 
vector cycle  10000n
receive delay 8000n
 
assign N0000 to nodes "CONFIG_IO0_PULLUP_RT7_8" ! Pin(s) B7
assign N0001 to nodes "EEPROM_LOAD0_EN_RT7_8" ! Pin(s) D10
...
assign N0002 to nodes "RT7_ADDR<1>" ! Pin(s) R7
assign N0003 to nodes "RT7_ADDR<2>" ! Pin(s) P7
assign N0004 to nodes "RT7_ADDR<3>" ! Pin(s) P8
assign N0005 to nodes "RT7_ADDR<4>" ! Pin(s) N9
assign N0006 to nodes "RT7_M4_0_3_SYNCE_CLK" ! Pin(s) N10
assign N0007 to nodes "RT7_M4_4_7_SYNCE_CLK" ! Pin(s) P10
assign N0008 to nodes "RT7_MDIO_SCL" ! Pin(s) C9
assign N0009 to nodes "RT7_MDIO_SDA" ! Pin(s) C10
...
message ""
! Set up Chain for Connect Test of device U1_RT7_8
pcf
use pcf order Scan
"10ZX1"!Suppress Ground Bounce
use pcf order Parallel
...
"001X1"!2+0
"101X1"
! Loading device U1_RT7_8 register BOUNDARY[92] (for EXTEST).
end pcf
message "IEEE Std 1149.1-2001 Integrity Failure"
message "  Device U1_RT7_8 has failed,"
message "  suspect device or these pins:"
...
"001L1"!4
"101X1"
! Loading device U1_RT7_8 with instruction EXTEST(00000).
"000H1"!17+0
"100X1"
"000L1"!1
"100X1"
...
"000L1"!2+0
"100X1"
! Unloading device U1_RT7_8 register BOUNDARY[92] (for EXTEST).
"001X1"!3+0 Vector 1725
"101X1"
"001X1"!1
"101X1"
"001X1"!2
...
use pcf order Scan
"11ZX1"!Select-DR-Scan
! End of Connect Test for device U1_RT7_8
"01ZX1"
"11ZX1"!Select-IR-Scan
use pcf order Parallel
"01ZX1XXXXXXXXXX"
...
!   42  39 U1_RT7_8.R7   RT7_ADDR<1>     'LHXX'
!   44  41 U1_RT7_8.P7   RT7_ADDR<2>     'LHXX'
!   46  43 U1_RT7_8.P8   RT7_ADDR<3>     'LHXX'
!   48  45 U1_RT7_8.N9   RT7_ADDR<4>     'LHXX'
!   50  47 U1_RT7_8.P10  RT7_M4_4_7_SYNCE_CLK'LHXX'
!   52  49 U1_RT7_8.N10  RT7_M4_0_3_SYNCE_CLK'LHXX'
!   88  85 U1_RT7_8.C10  RT7_MDIO_SDA    'LHXX'
!   90  87 U1_RT7_8.C9   RT7_MDIO_SCL    'LHXX'
!   92  89 U1_RT7_8.D10  EEPROM_LOAD0_EN_RT7_8'LHXX'
!   94  91 U1_RT7_8.B7   CONFIG_IO0_PULLUP_RT7_8'LHXX'
