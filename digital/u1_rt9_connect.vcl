...
! ITL Test Source File:      digital/u1_rt9_connect
! Test Name:                 U1_RT9
! VCL created for chain:     U29_U1_3
! Date: Wed May 11 15:32:56 2022
...
scan connect ! Test device U1_RT9
 
vector cycle  10000n
receive delay 8000n
 
assign N0000 to nodes "CONFIG_IO_PULLUP_RT9" ! Pin(s) B7
assign N0001 to nodes "EEPROM_LOAD_EN_RT9" ! Pin(s) D10
...
assign N0002 to nodes "RT9_ADDR<1>" ! Pin(s) R7
assign N0003 to nodes "RT9_ADDR<2>" ! Pin(s) P7
assign N0004 to nodes "RT9_ADDR<3>" ! Pin(s) P8
assign N0005 to nodes "RT9_ADDR<4>" ! Pin(s) N9
assign N0006 to nodes "RT9_M4_0_3_SYNCE_CLK" ! Pin(s) N10
assign N0007 to nodes "RT9_M4_4_7_SYNCE_CLK" ! Pin(s) P10
assign N0008 to nodes "RT9_MDIO_SCL" ! Pin(s) C9
assign N0009 to nodes "RT9_MDIO_SDA" ! Pin(s) C10
...
message ""
! Set up Chain for Connect Test of device U1_RT9
pcf
use pcf order Scan
"10ZX1"!Suppress Ground Bounce
use pcf order Parallel
...
use pcf order Scan
"101X1"
! Loading device U1_RT9 register BOUNDARY[92] (for EXTEST).
end pcf
message "IEEE Std 1149.1-2001 Integrity Failure"
message "  Device U1_RT9 has failed,"
message "  suspect device or these pins:"
...
"001L1"!6
"101X1"
! Loading device U1_RT9 with instruction EXTEST(00000).
"000H1"!7+0
"100X1"
"000L1"!1
"100X1"
...
use pcf order Scan
"100X1"
! Unloading device U1_RT9 register BOUNDARY[92] (for EXTEST).
"001X1"!1+0
"101X1"
"000X1"!1
"100X1"
...
use pcf order Scan
"11ZX1"!Select-DR-Scan
! End of Connect Test for device U1_RT9
"01ZX1"
"11ZX1"!Select-IR-Scan
use pcf order Parallel
"01ZX1XXXXXXXXXX"
...
!   40  39   U1_RT9.R7   RT9_ADDR<1>     'LHXX'
!   42  41   U1_RT9.P7   RT9_ADDR<2>     'LHXX'
!   44  43   U1_RT9.P8   RT9_ADDR<3>     'LHXX'
!   46  45   U1_RT9.N9   RT9_ADDR<4>     'LHXX'
!   48  47   U1_RT9.P10  RT9_M4_4_7_SYNCE_CLK'LHXX'
!   50  49   U1_RT9.N10  RT9_M4_0_3_SYNCE_CLK'LHXX'
!   86  85   U1_RT9.C10  RT9_MDIO_SDA    'LHXX'
!   88  87   U1_RT9.C9   RT9_MDIO_SCL    'LHXX'
!   90  89   U1_RT9.D10  EEPROM_LOAD_EN_RT9'LHXX'
!   92  91   U1_RT9.B7   CONFIG_IO_PULLUP_RT9'LHXX'
