...
! ITL Test Source File:      digital/u2_rt1_2_connect
! Test Name:                 U2_RT1_2
! VCL created for chain:     U29_U1_3
! Date: Wed May 11 15:25:02 2022
...
scan connect ! Test device U2_RT1_2
 
vector cycle  10000n
receive delay 8000n
 
assign N0000 to nodes "CONFIG_IO1_PULLUP_RT1_2" ! Pin(s) B7
assign N0001 to nodes "EEPROM_LOAD1_EN_RT1_2" ! Pin(s) D10
...
assign N0002 to nodes "RT2_ADDR<1>" ! Pin(s) R7
assign N0003 to nodes "RT2_ADDR<2>" ! Pin(s) P7
assign N0004 to nodes "RT2_ADDR<3>" ! Pin(s) P8
assign N0005 to nodes "RT2_ADDR<4>" ! Pin(s) N9
assign N0006 to nodes "RT2_M4_0_3_SYNCE_CLK" ! Pin(s) N10
assign N0007 to nodes "RT2_M4_4_7_SYNCE_CLK" ! Pin(s) P10
assign N0008 to nodes "RT2_MDIO_SCL" ! Pin(s) C9
assign N0009 to nodes "RT2_MDIO_SDA" ! Pin(s) C10
...
message ""
! Set up Chain for Connect Test of device U2_RT1_2
pcf
use pcf order Scan
"10ZX1"!Suppress Ground Bounce
use pcf order Parallel
...
"001X1"!7+0
"101X1"
! Loading device U2_RT1_2 register BOUNDARY[92] (for EXTEST).
end pcf
message "IEEE Std 1149.1-2001 Integrity Failure"
message "  Device U2_RT1_2 has failed,"
message "  suspect device or these pins:"
...
"001L1"!4
"101X1"
! Loading device U2_RT1_2 with instruction EXTEST(00000).
"000H1"!42+0
"100X1"
"000L1"!1
"100X1"
...
"001L1"!7+0
"101X1"
! Unloading device U2_RT1_2 register BOUNDARY[92] (for EXTEST).
"001X1"!8+0
"101X1"
"001X1"!1
"101X1"
...
use pcf order Scan
"11ZX1"!Select-DR-Scan
! End of Connect Test for device U2_RT1_2
"01ZX1"
"11ZX1"!Select-IR-Scan
use pcf order Parallel
"01ZX1XXXXXXXXXX"
...
!   47  39 U2_RT1_2.R7   RT2_ADDR<1>     'LHXX'
!   49  41 U2_RT1_2.P7   RT2_ADDR<2>     'LHXX'
!   51  43 U2_RT1_2.P8   RT2_ADDR<3>     'LHXX'
!   53  45 U2_RT1_2.N9   RT2_ADDR<4>     'LHXX'
!   55  47 U2_RT1_2.P10  RT2_M4_4_7_SYNCE_CLK'LHXX'
!   57  49 U2_RT1_2.N10  RT2_M4_0_3_SYNCE_CLK'LHXX'
!   93  85 U2_RT1_2.C10  RT2_MDIO_SDA    'LHXX'
!   95  87 U2_RT1_2.C9   RT2_MDIO_SCL    'LHXX'
!   97  89 U2_RT1_2.D10  EEPROM_LOAD1_EN_RT1_2'LHXX'
!   99  91 U2_RT1_2.B7   CONFIG_IO1_PULLUP_RT1_2'LHXX'
