...
! ITL Test Source File:      digital/u2_rt5_6_connect
! Test Name:                 U2_RT5_6
! VCL created for chain:     U29_U1_3
! Date: Wed May 11 15:28:54 2022
...
scan connect ! Test device U2_RT5_6
 
vector cycle  10000n
receive delay 8000n
 
assign N0000 to nodes "CONFIG_IO1_PULLUP_RT5_6" ! Pin(s) B7
assign N0001 to nodes "EEPROM_LOAD1_EN_RT5_6" ! Pin(s) D10
...
assign N0002 to nodes "RT6_ADDR<1>" ! Pin(s) R7
assign N0003 to nodes "RT6_ADDR<2>" ! Pin(s) P7
assign N0004 to nodes "RT6_ADDR<3>" ! Pin(s) P8
assign N0005 to nodes "RT6_ADDR<4>" ! Pin(s) N9
assign N0006 to nodes "RT6_M4_0_3_SYNCE_CLK" ! Pin(s) N10
assign N0007 to nodes "RT6_M4_4_7_SYNCE_CLK" ! Pin(s) P10
assign N0008 to nodes "RT6_MDIO_SCL" ! Pin(s) C9
assign N0009 to nodes "RT6_MDIO_SDA" ! Pin(s) C10
...
message ""
! Set up Chain for Connect Test of device U2_RT5_6
pcf
use pcf order Scan
"10ZX1"!Suppress Ground Bounce
use pcf order Parallel
...
"001X1"!3+0
"101X1"
! Loading device U2_RT5_6 register BOUNDARY[92] (for EXTEST).
end pcf
message "IEEE Std 1149.1-2001 Integrity Failure"
message "  Device U2_RT5_6 has failed,"
message "  suspect device or these pins:"
...
"001L1"!4
"101X1"
! Loading device U2_RT5_6 with instruction EXTEST(00000).
"000H1"!22+0
"100X1"! Vector 1575
"000L1"!1
"100X1"
...
"101X1"
! Unloading device U2_RT5_6 register BOUNDARY[92] (for EXTEST).
"001X1"!4+0
"101X1"
"001X1"!1
"101X1"
...
use pcf order Scan
"11ZX1"!Select-DR-Scan
! End of Connect Test for device U2_RT5_6
"01ZX1"
"11ZX1"!Select-IR-Scan
use pcf order Parallel
"01ZX1XXXXXXXXXX"
...
!   43  39 U2_RT5_6.R7   RT6_ADDR<1>     'LHXX'
!   45  41 U2_RT5_6.P7   RT6_ADDR<2>     'LHXX'
!   47  43 U2_RT5_6.P8   RT6_ADDR<3>     'LHXX'
!   49  45 U2_RT5_6.N9   RT6_ADDR<4>     'LHXX'
!   51  47 U2_RT5_6.P10  RT6_M4_4_7_SYNCE_CLK'LHXX'
!   53  49 U2_RT5_6.N10  RT6_M4_0_3_SYNCE_CLK'LHXX'
!   89  85 U2_RT5_6.C10  RT6_MDIO_SDA    'LHXX'
!   91  87 U2_RT5_6.C9   RT6_MDIO_SCL    'LHXX'
!   93  89 U2_RT5_6.D10  EEPROM_LOAD1_EN_RT5_6'LHXX'
!   95  91 U2_RT5_6.B7   CONFIG_IO1_PULLUP_RT5_6'LHXX'
